...
*/
class MyShapeMatchingObject : public MyPhysicsObject {
public:
	chai3d::cVector3d m_anchor;
	double m_spring = 10;
	double m_damper = 0.5;

	MyShapeMatchingObject(chai3d::cGenericObject* a_object, chai3d::cVector3d a_anchor) : MyPhysicsObject(a_object) { m_anchor = a_anchor; m_object->setLocalPos(m_anchor); }
